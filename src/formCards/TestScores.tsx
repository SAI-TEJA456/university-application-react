                    ...
                    <Card className="mt-3 p-3>">
                        ...
                        <Form>
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control type="number" name="greScore" value={formData.greScore || ""} onChange={handleChange}/>
                            ...
                            <Row>
                                ...
                                {/*    Gre verbal score*/}
                                    <Form.Group className="mb-3">
                                        ...
                                        <Form.Control type="number" name="greVerbalScore" value={formData.greVerbalScore || ""} onChange={handleChange}/>
                                ...
                                <Col md={6}>
                                    <Form.Group className="mb-3">
                                        ...
                                        <Form.Control type="number" name="greVerbalScore" value={formData.greQuantScore || ""} onChange={handleChange}/>
                    ...
                    <Card className="mt-3 p-3">
                        ...
                        <Form>
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control type="number" name="greVerbalScore" value={formData.ieltsScore || ""} onChange={handleChange}/>
                            ...
                            <Row>
                                ...
                                <Col md={3}>
                                    <Form.Group className="mb-3">
                                        ...
                                        <Form.Control type="number" name="greVerbalScore" value={formData.ieltsListScore || ""} onChange={handleChange}/>
                                ...
                                <Col md={3}>
                                    <Form.Group className="mb-3">
                                        ...
                                        <Form.Control type="number" name="greVerbalScore" value={formData.ieltsSpeakScore || ""} onChange={handleChange}/>
                                ...
                                <Col md={3}>
                                    <Form.Group className="mb-3">
                                        ...
                                        <Form.Control type="number" name="greVerbalScore" value={formData.ieltsReadScore || ""} onChange={handleChange}/>
                                ...
                                <Col md={3}>
                                    <Form.Group className="mb-3">
                                        ...
                                        <Form.Control type="number" name="greVerbalScore" value={formData.ieltsWriteScore || ""} onChange={handleChange}/>
                ...
                <Col md={6}>
                    <Card className="mt-3 p-3">
                        ...
                        <Form>
                            <Form.Group className="mb-3">
                                <Form.Label>Over all</Form.Label>
                                <Form.Control type="number" name="greVerbalScore" value={formData.tofelScore || ""} onChange={handleChange}/>
                            ...
                            <Row>
                                ...
                                <Col md={3}>
                                    <Form.Group className="mb-3">
                                        <Form.Label>Listening</Form.Label>
                                        <Form.Control type="number" name="greVerbalScore" value={formData.tofelListScore || ""} onChange={handleChange}/>
                                ...
                                <Col md={3}>
                                    <Form.Group className="mb-3">
                                        <Form.Label>Speaking</Form.Label>
                                        <Form.Control type="number" name="greVerbalScore" value={formData.tofelSpeakScore || ""} onChange={handleChange}/>
                                ...
                                <Col md={3}>
                                    <Form.Group className="mb-3">
                                        <Form.Label>Reading</Form.Label>
                                        <Form.Control type="number" name="greVerbalScore" value={formData.tofelReadScore || ""} onChange={handleChange}/>
                                ...
                                <Col md={3}>
                                    <Form.Group className="mb-3">
                                        <Form.Label>Writing</Form.Label>
                                        <Form.Control type="number" name="greVerbalScore" value={formData.tofelWriteScore || ""} onChange={handleChange}/>
                ...
                <Col md={6}>
                    <Card className="mt-3 p-3">
                        ...
                        <Form>
                            <Form.Group className="mb-3">
                                <Form.Label>Over all</Form.Label>
                                <Form.Control type="number" name="greVerbalScore" value={formData.duolingoScore || ""} onChange={handleChange}/>
